...
class ActiveRecord::Associations::Preloader
  ...
  def initialize(associate_by_default: T.unsafe(nil), polymorphic_parent: T.unsafe(nil), **kwargs); end

  def associate_by_default; end
  def associations; end
  def call; end
  def polymorphic_parent; end
  def preload(records, associations, preload_scope); end
  def records; end
  def scope; end

  private

  def build_child_preloader(reflection, child, loaders); end
  def build_preloaders; end
  def grouped_records(association); end
...
module ActiveRecord::Attributes::ClassMethods
  def attribute(name, cast_type = T.unsafe(nil), **options, &decorator); end
...
ActiveRecord::Migration::Compatibility::V6_2 = ActiveRecord::Migration::Current
